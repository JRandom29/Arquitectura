...
\node [mybox] (box){
    \begin{minipage}{0.46\textwidth}
        ...
        \begin{tabular}{lp{8cm} l} 
            ...
            \\\\
            $\scriptstyle\blacktriangledown$
            a menudo se desea relacionar cuantitativamante las prestaciones de dos
            \\
            máquinas diferentes.
            \\\\
            
            $n = \displaystyle\frac{\text{Prestaciones}_x}{\text{Prestaciones}_{y}}$
            \\\\
            $\scriptstyle\blacktriangledown$
            ...
            \\\\
            $ n= \displaystyle\frac{\text{Prestaciones}_x}{\text{Prestaciones}_{y}} = \displaystyle\frac{\text{Tiempo de ejecucion}_y}{\text{Tiempo de ejecucion}_x}$ 
	    \end{tabular}	
    \end{minipage}
};
%------------Titulo superior Izquierdo ---------------------
...
\node [mybox] (box){
    ...
    \\\\
    $\displaystyle\frac{\text{Potencia}_{Nuevo}}{\text{Potencia}_{Antiguo}}$
    \\\\
    $\blacktriangle$
...
\displaystyle\frac{1}{\left(1 + \left(\text{defectos por área} \times \text{área del dado}/2\right)\right)^{2}}
    ...
    \\
     Cuando se comparan dos computadores utilizando razones SPEC, es conveniente 
     \\
     utilizar la media geométrica porque nos da la misma respuesta relativa sin
      \\
      importar qué computador se utiliza como referencia para normalizar los tiempos\\\\
    $
    \displaystyle\sqrt[n]{\prod_{i=1}^{n} \text{Relaciones de tiempos de ejecución}_i}
    $
    \end{tabular}
    \end{minipage}
};
...
\end{gathered}
    ...
    \\\\
    $\text{MIPS} = \displaystyle\frac{\text{número de instrucciones}}{\text{tiempo de ejecución} \times 10^6} = \displaystyle\frac{\text{frecuencia de reloj}}{\text{CPI} \times 10^6}$    
